...
# ############################################## WCZYTYWANIE OBRAZÓW ################################################# #
img_gray = cv.imread('Image_2.png', 0)
...
up_thresh = 200     # TO DO STEROWANIA
gamma = 1.4        # TO DO STEROWANIA
...
thresh = 200 #TO DO STROWANIA

img_bin = cv.adaptiveThreshold(img_gray_filtr, thresh, cv.ADAPTIVE_THRESH_GAUSSIAN_C, cv.THRESH_BINARY_INV, 17, 5)
img_bin_bg = cv.adaptiveThreshold(img_gray_filtr, thresh, cv.ADAPTIVE_THRESH_GAUSSIAN_C, cv.THRESH_BINARY_INV, 21, 5)
